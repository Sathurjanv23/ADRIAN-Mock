...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-nova-bg text-nova-text flex flex-col">
        ...
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-3 group">
            ...
            <div>
              ...
              <span className="text-[10px] block text-nova-cyan font-mono leading-none">EMERGENCY NETWORK</span>
            </div>
          </Link>
          ...
          <div className="hidden md:flex items-center gap-6 text-sm text-nova-text-dim">
            ...
            <Link href="/about" className="text-nova-cyan font-medium">About</Link>
      ...
      {/* ─ Hero Section ─ */}
      <section className="relative py-20 px-6 overflow-hidden border-b border-nova-border/40">
        ...
        <div className="max-w-5xl mx-auto text-center space-y-6 relative z-10">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-nova-cyan/10 border border-nova-cyan/30 text-nova-cyan text-xs font-mono"
          >
          ...
          <motion.p
            ...
            className="text-base md:text-lg text-nova-text-dim max-w-3xl mx-auto leading-relaxed"
          >
      ...
      <section className="py-16 px-6 max-w-7xl mx-auto w-full">
        <div className="text-center mb-12 space-y-2">
          ...
          <p className="text-sm text-nova-text-dim">Five dedicated roles operating on a unified real-time infrastructure</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="nova-card border border-nova-border rounded-2xl p-6 space-y-4 hover:border-nova-cyan/40 transition-all">
            ...
            <Link href="/command" className="inline-flex items-center gap-1.5 text-xs text-nova-cyan font-bold hover:underline pt-2">
      ...
      {/* ─ Quick CTA Footer ─ */}
      <footer className="mt-auto border-t border-nova-border/50 py-10 px-6 bg-nova-surface/20">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-3">
            <ShieldAlert className="w-5 h-5 text-nova-cyan" />
            <span className="font-mono text-xs text-nova-text-muted">PROJECT NOVA — Autonomous Emergency Response Network</span>
          </div>

          <div className="flex items-center gap-6 text-xs text-nova-text-dim">
            ...
            <Link href="/command" className="hover:text-nova-cyan">Command Center</Link>
